...
Finally, we find some differences. The REML method changes the linear mixed model by the standard deviation and (obviously) the log-likelihood. But it doesn't change the fixed coefficient.\\
\newline
